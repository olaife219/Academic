    ...
    <section class="watch-video">
        ...
        if ($select_content->rowCount() > 0) {
            while ($fetch_content = $select_content->fetch(PDO::FETCH_ASSOC)) {
                ...
                ?>
                <div class="content">
                    <video src="uploaded_files/<?= $fetch_content['video']; ?>" controls autoplay
                    ...
                    <form action="" method="POST" class="flex">
                        ...
                        <?php if ($user_likes->rowCount() > 0) { ?>
                            <button type="submit" class="inline-btn" name="like_content"><i
                                    class="fas fa-heart"></i><span>liked</span></button>
                        <?php } else { ?>
                            <button type="submit" class="inline-option-btn" name="like_content"><i
